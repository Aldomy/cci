  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content form-elegant">
      ...
      <div class="modal-body mx-4">
        ...
        <div class="md-form pb-3">
          ...
          <div class="row">
            ...
            <div class="col-6">
            <p class="font-small blue-text text-right"> <a href="#" data-toggle="modal" data-target="#modalForgetForm"  class="blue-text ml-1">
              Forgot Password?</a></p>
            </div>
          </div>
      ...
      <div class="modal-footer mx-5 pt-3 mb-1">
        <p class="font-small grey-text d-flex justify-content-end">Not a member? <a href="" data-toggle="modal" data-target="#registerModalForm" class="blue-text ml-1">
            Sign Up</a></p>
      </div>
    </div>
    <!--/.Content-->
